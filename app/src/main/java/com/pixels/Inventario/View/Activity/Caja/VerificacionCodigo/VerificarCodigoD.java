package com.pixels.Inventario.View.Activity.Caja.VerificacionCodigo;
...
public class VerificarCodigoD {
    private alertVentaDevolucion Context;
    public VerificarCodigoD(alertVentaDevolucion context){
    ...
    public void verificarcodigo(boolean verficarr){
        if(verficarr){
            ...
            verificar.reset();
            verificar.verificarCodigo(Context.Codigo.getText().toString(),Context.Context);
