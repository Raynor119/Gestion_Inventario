...
public class VerVentasAnualesSQLite extends BaseDatosSQLite implements MediadorBaseDatos {

    public VentasAnualesRecyclerViewModel ViewModel;
    private String Consulta="";
    public VerVentasAnualesSQLite(Context context, VentasAnualesRecyclerViewModel viewModel, String consulta) {
        super(context);
