...
public class VerVentasAnualesMYSQL extends Conexion implements MediadorBaseDatos {
    public VentasAnualesRecyclerViewModel ViewModel;
    public List<TotalVentas> ventas;
    private boolean verificarE=false;
    private String Consulta="";
    public VerVentasAnualesMYSQL(Context context, VentasAnualesRecyclerViewModel viewModel, String consulta) {
        super(context);
