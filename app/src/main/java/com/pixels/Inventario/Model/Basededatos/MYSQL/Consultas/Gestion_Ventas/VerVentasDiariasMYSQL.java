...
public class VerVentasDiariasMYSQL extends Conexion implements MediadorBaseDatos {
    public VentasDiariasRecyclerViewModel ViewModel;
    public List<TotalVentas> ventas;
    private boolean verificarE=false;
    private String Consulta="";
    public VerVentasDiariasMYSQL(Context context, VentasDiariasRecyclerViewModel viewModel, String consulta) {
        super(context);
