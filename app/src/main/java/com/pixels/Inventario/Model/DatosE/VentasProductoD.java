...
public class VentasProductoD {
        ...
        public VentasProductoD(int id,int codigoV,String codigoP,String nombre, double cantidadV,int costePV,int precioPV,int iva,String estadoDevolucion,String observacionD) {
            this.Id=id;
