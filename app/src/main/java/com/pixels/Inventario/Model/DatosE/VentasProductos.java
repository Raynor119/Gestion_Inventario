...
public class VentasProductos {
    ...
    public VentasProductos(int id,int codigoV,String codigoP, double cantidadV,double cantidadD,int costePV,int precioPV,int iva,String estadoDevolucion,String observacionD) {
        this.Id=id;
