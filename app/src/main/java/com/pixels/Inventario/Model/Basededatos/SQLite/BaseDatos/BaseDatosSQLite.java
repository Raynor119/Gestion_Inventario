...
public class BaseDatosSQLite extends SQLiteOpenHelper {
    ...
    private static final String TABLAVentasProductos="CREATE TABLE VentasProductos(Id INTEGER PRIMARY KEY AUTOINCREMENT,codigoV INT NOT NULL,codigoP VARCHAR(255),CantidadV DOUBLE NOT NULL,CantidadD DOUBLE NOT NULL,CostePV BIGINT NOT NULL,PrecioPV BIGINT NOT NULL,IvaPV INT NOT NULL,ObservacionD VARCHAR(255),FOREIGN KEY (codigoV) REFERENCES Venta(codigo),FOREIGN KEY (codigoP) REFERENCES Producto(codigo) ON UPDATE CASCADE)";
