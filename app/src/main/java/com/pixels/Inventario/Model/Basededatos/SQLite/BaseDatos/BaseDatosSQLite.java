...
public class BaseDatosSQLite extends SQLiteOpenHelper {
    ...
    private static final String TABLAVenta="CREATE TABLE Venta(codigo SERIAL NOT NULL,Fecha TEXT NOT NULL,TotalV BIGINT NOT NULL,PRIMARY KEY (codigo))";
    private static final String TABLAVentasProductos="CREATE TABLE VentasProductos(codigoV SERIAL NOT NULL,codigoP VARCHAR(255) NOT NULL,PRIMARY KEY (codigoV,codigoP),FOREIGN KEY (codigoV) REFERENCES Venta(codigo),FOREIGN KEY (codigoP) REFERENCES Producto(codigo))";
