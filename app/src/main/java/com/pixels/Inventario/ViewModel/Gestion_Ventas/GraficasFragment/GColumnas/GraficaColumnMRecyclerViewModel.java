...
import com.pixels.Inventario.Model.Basededatos.MYSQL.Consultas.Gestion_Ventas.GraficasFragment.GColumnas.ProductosVendidosMMYSQL;
...
import com.pixels.Inventario.Model.Basededatos.SQLite.BaseDatos.Consultas.Gestion_Ventas.GraficasFragment.GColumnas.ProductosVendidosMSQLite;
import com.pixels.Inventario.Model.Basededatos.SQLite.DatosInicio.consultasDatos;
import com.pixels.Inventario.Model.DatosE.DatosColumn;

import java.util.List;

public class GraficaColumnMRecyclerViewModel extends ViewModel {
    public MutableLiveData<List<DatosColumn>> resultado;

    public GraficaColumnMRecyclerViewModel(){
    ...
    public void buscarVProductos(Context context, String Consulta){
        ...
        if(dinici.obtenerD().get(0).getBasedatos().equals("SQLITE")){
            BD= new ProductosVendidosMSQLite(context, GraficaColumnMRecyclerViewModel.this,ConsultaP);
        }
        if(dinici.obtenerD().get(0).getBasedatos().equals("MYSQL")){
            BD= new ProductosVendidosMMYSQL(context, GraficaColumnMRecyclerViewModel.this,ConsultaP);
        }
    }
}
